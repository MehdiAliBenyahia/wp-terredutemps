...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'eduberg' ); ?></a>
			...
			<div class="head-wrap-inner">
				<div class="site-branding">
					<div class="site-title-wrap">
						...
						<?php $site_identity = eduberg_get_option( 'site_identity' );
						...
						if( 'logo-only' == $site_identity ){  
							...
							$eduberg_description = get_bloginfo( 'description', 'display' );

							if ( $eduberg_description || is_customize_preview() ) :
								?>
								<p class="site-description"><?php echo $eduberg_description; /* WPCS: xss ok. */ ?></p>
							<?php endif; 
				...
				<div id="main-navigation-wrap" class="navigation-wrap">
					...
					<div class="additional-menu-item additional-btn navbar-left">
					    <div class="navbar-left navbar-btn-right">
					        ...
					        $show_social_icons = eduberg_get_option( 'show_social_icons' );
					        ...
					        $show_cart_icon = eduberg_get_option( 'show_cart_icon' );
					        ...
					        $nav_button_text = eduberg_get_option( 'nav_button_text' );
					        $nav_button_link = eduberg_get_option( 'nav_button_link' );
